...
public class MenuImpl extends Thread implements Menu {
   ...
   public void inoutput() throws Exception {
      ...
      case 1:
         ...
         while (cnt < 1) {
            String[] drink = { "", " _    _   ___   _____  _____ ______ ", "| |  | | / _ \\ |_   _||  ___|| ___ \\",
                  "| |  | |/ /_\\ \\  | |  | |__  | |_/ /", "| |/\\| ||  _  |  | |  |  __| |    / ",
                  "\\  /\\  /| | | |  | |  | |___ | |\\ \\ ", " \\/  \\/ \\_| |_/  \\_/  \\____/ \\_| \\_|",
                  "                                    ", "                                    " };
      ...
      case 2:
         ...
         while (cnt < 1) {
            String[] drink = { "\n", " _____  _____  _   __ _____ ", "/  __ \\|  _  || | / /|  ___|",
                  "| /  \\/| | | || |/ / | |__  ", "| |    | | | ||    \\ |  __| ",
      ...
      case 3:
         ...
         while (cnt < 1) {
            String[] drink = { "", " _____ ______ ______  _____  _____  _____ ",
      ...
      case 4:
         ...
         while (cnt < 1) {
            String[] drink = { "", "______  _____  _____ ______ ", "| ___ \\|  ___||  ___|| ___ \\",
                  "| |_/ /| |__  | |__  | |_/ /", "| ___ \\|  __| |  __| |    / ",
                  "| |_/ /| |___ | |___ | |\\ \\ ", "\\____/ \\____/ \\____/ \\_| \\_|",
                  "                            ", "                            " };
      ...
      case 5:
         ...
         while (cnt < 1) {
            String[] drink = { "", "___  ___  ___   _   __ _____  _____  _____  _      _      _____ ",
                  "|  \\/  | / _ \\ | | / /|  __ \\|  ___||  _  || |    | |    |_   _|",
                  "| .  . |/ /_\\ \\| |/ / | |  \\/| |__  | | | || |    | |      | |  ",
                  "| |\\/| ||  _  ||    \\ | | __ |  __| | | | || |    | |      | |  ",
   ...
   public void mmmain() {
      ...
      do {
         try {
            ...
            System.out.println("|￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣|");
            System.out.println("|　음료를 구매하거나 쿠폰을 사용하실 수 있습니다. 　　　　　                       　|");
            System.out.println("|　하단에서 원하는 메뉴를 선택해주세요.　　　　　　　　　　　 　　　　　　　　　　　 |");
            System.out.println("|　　　　 ＿＿＿＿＿＿　　　       　＿＿＿＿＿＿　　　     　＿＿＿＿＿＿　　　　 　|");
            System.out.println("| 　　 　｜1. 구  매 |　　　        ｜2.쿠폰사용｜           ｜3.처음으로｜ 　     　|");
            System.out.println("|　　 　　￣￣￣￣￣￣　　　　       ￣￣￣￣￣￣　　　     　￣￣￣￣￣￣　　　 　　|");
            System.out.println("￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣");
